...
<meta name="description" content="You must not encourage others to break any of the RuneScape rules.">
</head>
<body>
...
<h4>BrainScape - Rule 9</h4>
<a href="../ex/rules.php">Go Back</a>
</div>
</div>
...
<body>
<br>
You must not encourage others to break any of the BrainScape rules.<br>
<br>
...
<br>
Examples of encouraging others to break any of the BrainScape rules would include:<br>
<ul style="margin-top: 0px; margin-bottom: 0px;">
<li style="list-style: none">
<br>
</li>
<li>Attempting to convince other players that the rules of BrainScape are different from what they actually are.<br>
</li>
<li>Trying to get a reaction from another player by using offensive language against them.<br>
</li>
<li>Creating, distributing or advertising third party BrainScape add-ons which break Rule 7.<br>
</li>
<li>Advertising or linking to real-world trading websites which break Rule 12.<br>
</li>
<li>Encouraging others to abuse bugs - any bugs found should be reported to BrainScape immediately.<br>
</li>
...
<br>
<i>To keep BrainScape enjoyable for everyone please observe and follow this rule. We will not tolerate disruptive players, and if you break our rules your account is likely to be banned. Members who are banned for breaking our rules are not entitled to any sort of refund.</i>
<br style="clear: both;">
</body>
<div class="spacer">
