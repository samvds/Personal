...
<title>BrainScape - How Does The System Appeal Work</title>
...
<h4>BrainScape - How Does The Appeal System Work</h4>
<a href="../ex/bnm.php">Go Back</a>
</div>
</div>
...
<h1>How Does The Appeal System Work</h1>
<body>
By reporting players that are also called 'rule breakers' that are breaking the rules therefor you are strictly helping us, we are 24/7 looking for rule breakers, so thanks to everyone that are reporting our 'rule breakers'.
<br><br>
The Appeal System is our way of ensuring that we are making the right decisions, as well as giving you the opportunity to reflect on what you have done.
<br><br>
<h4 style="display: inline;">How It Works</h4><br>
Well, let's begin, when a Moderator or Administrator mutes/bans a player, they would have to do ::mute/::ban the user, when they do that it will send a report onto the server files where I can check what the player did. If you are the muted/banned user you will then give me your username and I will look up then give you the report.<br>Then you will be able to appeal your offence in via forums.<br>
</body>
<div class="spacer">
